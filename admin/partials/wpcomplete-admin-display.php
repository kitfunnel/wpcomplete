...
<div class="wpcomplete-settings wrap">
  ...
  <?php if ( isset( $_GET['sl_activation'] ) && ( $_GET['sl_activation'] == 'false' ) ) { ?>
  <div class="error">
    <?php if (  isset( $_GET['message'] ) && ( $message = urldecode( $_GET['message'] ) ) ) { ?>
  ...
  <nav class="nav-tab-wrapper">
    <a href="?page=wpcomplete&amp;tab=general" class="nav-tab<?php echo $active_tab == 'general' ? ' nav-tab-active' : ''; ?>">General</a>
    <a href="?page=wpcomplete&amp;tab=buttons" class="nav-tab<?php echo $active_tab == 'buttons' ? ' nav-tab-active' : ''; ?>">Buttons</a>
    <a href="?page=wpcomplete&amp;tab=graphs" class="nav-tab<?php echo $active_tab == 'graphs' ? ' nav-tab-active' : ''; ?>">Graphs</a>
    <a href="?page=wpcomplete&amp;tab=advanced" class="nav-tab<?php echo $active_tab == 'advanced' ? ' nav-tab-active' : ''; ?>">Advanced</a>
  </nav>
  ...
  <div class="sidebar">
    ...
    <!-- FREE: -->
    <div class="postbox">
      <h2><span>Update to <?php echo WPCOMPLETE_PRODUCT_NAME; ?> PRO</span></h2>
      <div class="inside">
        ...
        <p><a href="<?php echo WPCOMPLETE_STORE_URL; ?>">Check out all the benefits</a></p>
      </div>
    </div>
    ...
    <div class="postbox">
      ...
      <div class="inside">
        <?php if (!WPCOMPLETE_IS_ACTIVATED) : ?>
        <!-- FREE: -->
        <p>Need help? We’ve got <a href="https://help.ithemes.com/hc/en-us/categories/360004523854-WPComplete" target="_blank">a complete support section</a> on our website to help you find what you’re looking for. Need more? Our <a href="<?php echo WPCOMPLETE_STORE_URL; ?>">PRO version</a> comes with email support, but feel free to ping us on the <a href="https://wordpress.org/support/plugin/<?php echo WPCOMPLETE_PREFIX; ?>">WordPress support forum</a>.</p>
        <?php else : ?>
        <!-- PREMIUM: -->
  ...
  <hr>
  <p>If you like <?php echo WPCOMPLETE_PRODUCT_NAME; ?>, please <a href="https://wordpress.org/support/view/plugin-reviews/<?php echo WPCOMPLETE_PREFIX; ?>">leave us a ★★★★★ rating</a>. Your votes really make a difference! Thanks.</p>
